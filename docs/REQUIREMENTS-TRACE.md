...
| 17 | "...**portal screen flows**..." | Seventeen routes exist and are screenshotted at desktop and 390 pixels, which is the flow made concrete rather than drawn. | `npm run verify:borrowers`, `verify:scenarios`, `verify:workflow`. | `docs/screenshots/README.md`; `docs/screenshots/live-run.md`, live shots 39, 43, 45, 46 | Verified live |
